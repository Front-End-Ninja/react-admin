    ...
    return (React.createElement(ra_core_1.ResourceContextProvider, { value: props.reference },
        React.createElement(ra_core_1.ReferenceArrayInputContextProvider, { value: controllerProps },
            React.createElement(ra_core_1.ListContextProvider, { value: listContext },
                React.createElement(exports.ReferenceArrayInputView, __assign({ id: id, input: input, isRequired: isRequired, meta: meta, translate: translate, children: children }, props, controllerProps))))));
};
